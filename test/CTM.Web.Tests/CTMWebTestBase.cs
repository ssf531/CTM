...
{
    public abstract class CTMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CTMWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CTMWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CTMDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CTMDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CTMDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CTMDbContext, Task<T>> func)
        {
            T result;
